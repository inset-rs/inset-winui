...
WinUI 3's controls on Inset, ported from `/Users/mac/code/microsoft-ui-xaml`. See the workspace `AGENTS.md` for where each kind of fact lives in that repository and the rules.

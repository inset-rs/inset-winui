//! WinUI TextBox template and behavior, using Reveal’s native editing engine.
...
use reveal_embedder::{Color, TextAlign, TextSelection};
use reveal_foundation::{App, Handle};
use reveal_services::{SelectionChangedCause, TextInputFormatterRef};
use reveal_widgets::*;
use std::{fmt, rc::Rc};

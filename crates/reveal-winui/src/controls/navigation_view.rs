...
use reveal_embedder::{Color, FontWeight, Offset, Rect, TextDirection};
use reveal_foundation::{App, Handle, Listenable, Listener};
use reveal_painting::{Alignment, EdgeInsetsGeometry};
use reveal_rendering::{BoxConstraints, CrossAxisAlignment, MainAxisSize, StackFit};
...
impl NavigationViewState {
    ...
    fn left_template(self: Handle<Self>, app: &mut App, context: BuildContext) -> WidgetRef {
        ...
        if widget.is_pane_visible && (chrome.show_back || chrome.show_close) {
            ...
            .key(Rc::new(reveal_foundation::ValueKey::new(if close {
        ...
        if chrome.show_toggle {
            ...
            .key(Rc::new(reveal_foundation::ValueKey::new(
                "TogglePaneButton",
            )))
            .template(move |app, context, states, child| {

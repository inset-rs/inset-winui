//! ElevationHelper.cpp and DropShadowRecipe.h, using Reveal's native shadow blur.

use crate::{OVERLAY_CORNER_RADIUS, Theme};
use reveal_embedder::{BlurStyle, Canvas, ClipOp, Color, Offset, RRect, Radius, Size};
use reveal_foundation::App;
use reveal_painting::{BoxShadow, draw_rrect};
